    ...
    <section id="contact" className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold text-slate-900 mb-6" data-aos="fade-up">Get in Touch</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Contact Form */}
          <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-200" data-aos="fade-up" data-aos-delay="200">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-blue-700 transition-all duration-200 transform hover:scale-105"
              >
                Send Message
              </button>
            </form>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
              ...
              <div className="space-y-4">
                <a
                  ...
                  className="block w-full bg-blue-600 text-white text-center py-3 px-6 rounded-lg font-semibold hover:bg-blue-700 transition-all duration-200"
                >
                  Email Us Directly
                </a>
                ...
                <a
                  ...
                  className="block w-full bg-slate-600 text-white text-center py-3 px-6 rounded-lg font-semibold hover:bg-slate-700 transition-colors duration-200"
                >
                  WhatsApp Support
                </a>
